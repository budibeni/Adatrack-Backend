...
MODULES=(internal services/ingestion-tcp services/worker-live services/worker-persistence services/worker-alert services/service-websocket services/api-vehicle services/foundation-check)
flags=()
target=""
run_e2e=false
for arg in "$@"; do
