...
| MEDIUM | Codec 7 | `0x07` | Short codec (no priority, no event) | ⬜ Dropped (removed — unverified, no test) |
...
| Codec 7 parsing | Dropped | Previously in `ingestion-tcp/controllers/teltonika.go` (removed 2026-09-06) |
